    ...
    <div class="flex gap-4 p-3">
      ...
      <div class="flex flex-col justify-center items-start w-60">
        ...
        <div class="flex flex-wrap">
          <span v-for="playgroundFunction in playgroundFunctions" :key="playgroundFunction"
                class="inline-block bg-gray-700 rounded-full px-3 py-1 text-sm font-semibold text-white mr-2 mb-2">{{ playgroundFunction }}</span>
        </div>
      </div>
    </div>
  </li>
